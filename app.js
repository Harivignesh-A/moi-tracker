...
// Parses numeric values. If the value is a string gift (e.g. "3 gm gold"), returns null.
function parseAmount(value) {
  ...
  // Not a pure number (it's a descriptive text string gift)
  return null;
}
...
function showPerson(name) {
  ...
  // Check if there are non-numeric text gifts
  ...
  if (!transactions.length) {
    ...
    for (const row of transactions) {
      ...
      // Display text string as-is in table, or formatted currency if number
